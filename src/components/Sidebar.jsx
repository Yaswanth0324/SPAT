...
const Sidebar = ({ links, title }) => {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      >
        <img src={isDark ? "/sapt-logo1.png" : "/sapt-logo2.png"} className="w-10 h-10 object-contain rounded-xl" alt="SAPT Logo" />
        <div>
          <p className="font-display font-bold text-primary-600 text-sm leading-tight">SAPT</p>
